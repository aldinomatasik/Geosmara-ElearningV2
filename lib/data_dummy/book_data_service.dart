  ...
  return Book(
    ...
    chapters: [
      Chapter(
        ...
        subChapters: [
          SubChapter(id: '1-1-1', title: 'What is Flutter?'),
          SubChapter(id: '1-1-2', title: 'Flutter Architecture'),
          SubChapter(id: '1-1-3', title: 'Getting Started'),
        ],
      ),
      Chapter(
        id: '1-2',
        ...
        subChapters: [
          SubChapter(id: '1-2-1', title: 'Project Setup'),
          SubChapter(id: '1-2-2', title: 'Widget Tree'),
          SubChapter(id: '1-2-3', title: 'Running the App'),
        ],
      ),
      Chapter(
        id: '1-3',
        ...
        subChapters: [
          SubChapter(id: '1-3-1', title: 'Basic Widgets'),
          SubChapter(id: '1-3-2', title: 'Layout Widgets'),
          SubChapter(id: '1-3-3', title: 'Custom Widgets'),
        ],
      ),
    ],
  );
  ...
  return Book(
    ...
    chapters: [
      Chapter(
        ...
        subChapters: [
          SubChapter(id: '2-1-1', title: 'What is React Native?'),
          SubChapter(id: '2-1-2', title: 'Components & JSX'),
        ],
      ),
      Chapter(
        id: '2-2',
        ...
        subChapters: [
          SubChapter(id: '2-2-1', title: 'React Navigation'),
          SubChapter(id: '2-2-2', title: 'State Management',),
        ],
      ),
    ],
  );
  ...
  return Book(
    ...
    chapters: [
      Chapter(
        ...
        subChapters: [
          SubChapter(id: '3-1-1', title: 'Swift Basics'),
          SubChapter(id: '3-1-2', title: 'Data Types'),
        ],
      ),
    ],
  );
  ...
  return Book(
    ...
    chapters: [
      Chapter(
        ...
        title: 'Kotlin Basics',
        subChapters: [
          SubChapter(id: '4-1-1', title: 'Introduction to Kotlin'),
        ],
      ),
    ],
  );
  ...
  return Book(
    ...
    chapters: [
      Chapter(
        ...
        subChapters: [
          SubChapter(id: '5-1-1', title: 'What is Vue?'),
        ],
      ),
    ],
  );
